 ...
 */
class UriAdapter : com.squareup.moshi.JsonAdapter<Uri>() {
    override fun fromJson(reader: com.squareup.moshi.JsonReader): Uri? {
        val uriString = reader.nextString()
        return if (uriString.isEmpty()) null else Uri.parse(uriString)
    }

    override fun toJson(writer: com.squareup.moshi.JsonWriter, value: Uri?) {
